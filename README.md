...
## Pipeline Workflow
1. Download sequencing data (SRA → FASTQ using fasterq-dump)
2. Quality check with FastQC
3. Adapter trimming & filtering with Fastp
4. Genome assembly using SPAdes
5. Assembly evaluation with QUAST
6. Graph visualization with Bandage
...
<p align="center">
  <img src="https://github.com/genome-miner/mycoplasma-assembly-pipeline/blob/main/Bandage/Asssembly%20graph.png?raw=true" alt="Alt text" width="600">
</p>
